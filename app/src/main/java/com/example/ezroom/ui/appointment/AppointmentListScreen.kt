...
fun AppointmentListScreen(
    ...
    val dummyData = remember {
        listOf(
            Appointment("1", "Phòng trọ cao cấp Q7", "Nguyễn Văn A", "20/05/2024", "14:00", "Em muốn qua xem phòng trực tiếp", "Pending"),
            Appointment("2", "Căn hộ Studio tiện nghi", "Lê Thị B", "21/05/2024", "09:30", "", "Approved"),
            Appointment("3", "Phòng trọ giá rẻ", "Trần Văn C", "19/05/2024", "16:00", "Hẹn gặp ở đầu ngõ", "Canceled"),
            Appointment("4", "Phòng trọ cao cấp Q7", "Phạm Đức Anh", "22/05/2024", "10:00", "Check inbox em nhé", "Pending")
        )
    }
                    ...
                    Tab(
                        ...
                        text = {
                            Text(
                                ...
                                color = if (selectedTabIndex == index) OrangePrimary else OnSurfaceVariantLight
                            )
                        }
                    )
                }
                ...
                LazyColumn(
                    ...
                    items(filteredList) { item ->
                        AppointmentCard(
                            ...
                            status = item.status,
                            isHost = isHost,
                            onAccept = { /* Xử lý gọi API Accept */ },
                            onReject = { /* Xử lý gọi API Reject */ }
                        )
                    }
                }
            }
