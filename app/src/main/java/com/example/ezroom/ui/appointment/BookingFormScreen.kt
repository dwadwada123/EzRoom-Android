package com.example.ezroom.ui.screens
...
import com.example.ezroom.ui.theme.OutlineLight
import com.example.ezroom.ui.theme.OnSurfaceVariantLight
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                colors = OutlinedTextFieldDefaults.colors(
                    ...
                    unfocusedPlaceholderColor = OnSurfaceVariantLight
                )
            )
...
fun BookingFormScreenPreview() {
    EzRoomTheme {
        BookingFormScreen(
            roomName = "Phòng trọ sinh viên giá rẻ",
            onNavigateBack = {},
